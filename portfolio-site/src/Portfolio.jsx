...
const PROJECTS = [
  {
    ...
    color: "#2A6F77",
    accent: "#4A9DA5",
    preview: `${IMG}invictus_trainee_dashboard.png`,
    figmaUrl: "https://www.figma.com/design/XWpDUfkT0FveHSegLtgjmp/Invictus-Bakery-Dashboard?node-id=12-956&t=VhndRB5tCyem6gXm-1",
    summary: "Designing an internal operations dashboard for Invictus Bakery, a NYC-based nonprofit that runs baking programs for adults with disabilities — replacing a manual spreadsheet workflow with a proper admin tool, with separate views for instructors, trainees, and guardians.",
    context: "Invictus Bakery needed a way to manage day-to-day operations that didn't rely on passing spreadsheets back and forth. Instructors, trainees, and guardians all needed different levels of access and different information — instructors needed scheduling and roster tools, trainees needed a simple view of their day, and guardians needed visibility without extra functionality they didn't need.",
    process: [
      { heading: "Mapping Three Portals", text: "Started by scoping what each user type actually needed to see. Instructors needed the most functionality — dashboards, trainee rosters, and scheduling. Trainees needed a simple daily workflow. Guardians needed view-only visibility into their trainee's progress, since parents mainly want to know what's happening without managing anything themselves.", images: [{ src: `${IMG}invictus_portals_overview.png`, caption: "Instructor, Trainee, and Guardian portal overview" }] },
      { heading: "Instructor Dashboard", text: "Built out the instructor dashboard with a calendar, trainee roster, and today's/tomorrow's schedule side by side, then went through several rounds of feedback on information hierarchy and how trainee rows should surface status.", images: [{ src: `${IMG}invictus_instructor_dashboard.png`, caption: "Instructor dashboard iterations with feedback annotations" }] },
      { heading: "Trainee & Guardian Views", text: "Designed a simpler trainee dashboard focused on the day's workflow — what to bake, timers, and their own information — and a guardian dashboard that mirrors it but strips out any editing functionality, since guardian access is meant to be read-only.", images: [{ src: `${IMG}invictus_guardian_dashboard.png`, caption: "Guardian dashboard, view-only by design" }] },
    ...
    outcome: "The dashboard work is ongoing, with instructor and trainee workflows still being refined. At the end of the day, this is all in service of the trainees and instructors who show up to bake together — the people the tool is actually for.",
    peopleImage: `${IMG}invictus_mixing_group.jpg`,
  },
  {
    id: "ocse",
...
function Hero({ onNavigate }) {
  return (
    <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px 32px 80px", maxWidth: "1080px", margin: "0 auto" }}>
      <div style={{ display: "flex", gap: "56px", flexWrap: "wrap", alignItems: "center", width: "100%" }}>
        <div style={{ flex: "1 1 460px", minWidth: "280px" }}>
          ...
          <h1 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: "clamp(36px, 5.6vw, 56px)", color: "#1a1a1a", lineHeight: 1.12, marginBottom: "24px", letterSpacing: "-0.02em", fontWeight: 400 }}>
            Hi, I'm Jacob Brown.
          </h1>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "18px", lineHeight: 1.7, color: "#666", maxWidth: "480px", marginBottom: "40px" }}>Computer Science & English student at UNC Chapel Hill. I turn user research into polished interfaces — from wireframes to high-fidelity prototypes.</p>
        ...
        <div style={{ flex: "0 0 auto", position: "relative", width: "300px", height: "360px", margin: "0 auto" }}>
          <svg viewBox="0 0 300 300" style={{ position: "absolute", top: "-30px", left: "-40px", width: "220px", height: "220px", zIndex: 0 }}>
            <path fill="#F6DCD3" d="M150,30 C210,20 270,60 275,130 C280,200 230,260 160,270 C90,280 30,230 25,160 C20,90 90,40 150,30 Z" />
          </svg>
          <svg viewBox="0 0 300 300" style={{ position: "absolute", bottom: "-35px", right: "-35px", width: "190px", height: "190px", zIndex: 0 }}>
            <path fill="#DCE8DE" d="M150,35 C205,25 265,70 270,135 C275,195 220,255 155,265 C95,275 35,225 30,155 C25,90 95,45 150,35 Z" />
          </svg>
          <img src="/images/headshot.jpg" alt="Jacob Brown" style={{ position: "relative", zIndex: 1, width: "100%", height: "100%", objectFit: "cover", borderRadius: "20px", boxShadow: "0 20px 50px rgba(0,0,0,0.15)" }} />
        </div>
      </div>
    </section>
  );
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 32px 64px" }}>
        ...
        {project.peopleImage && (
          <div style={{ marginTop: "24px" }}>
            <img src={project.peopleImage} alt={`${project.title} — the people behind the work`} style={{ width: "100%", borderRadius: "4px", display: "block" }} />
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "13px", color: "#999", marginTop: "10px", textAlign: "center" }}>The trainees and instructors at Invictus Bakery — who this project is ultimately for.</p>
          </div>
        )}
      </div>
...
function Contact() {
  return (
    <section id="contact" style={{ padding: "80px 32px 120px", maxWidth: "900px", margin: "0 auto", borderTop: "1px solid rgba(0,0,0,0.06)" }}>
      ...
      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "16px", color: "#555", lineHeight: 1.8, marginBottom: "32px", maxWidth: "500px" }}>I'm currently looking for a UX Design internship for Summer 2027. If you'd like to chat about design, collaboration, or opportunities — I'd love to hear from you.</p>
