...
const PROJECTS = [
  ...
  },
  {
    ...
    process: [
      { heading: "Personas & Problem Space", text: "Identified five key user pain points: doom-scrolling fatigue, all-or-nothing news consumption, unpredictable emotional hits, guilt about staying informed, and context collapse leading to burnout. Created two personas — Frank Schooler (a recent college grad overwhelmed by information) and Lauren Llama (a mom of three exhausted by negativity in traditional news).", images: [{ src: `${IMG}tunedin-persona-1.png`, caption: "Persona — Frank Schooler" }, { src: `${IMG}tunedin-persona-2.png`, caption: "Persona — Lauren Llama" }] },
      { heading: "Product Design", text: "Designed the full app experience: a capacity slider asking \"How do you feel?\" (Frustrated, Sad, Anxious, Happy), mood-matched content recommendations, reading streaks for gamification, and both list and card view layouts. The warm, muted pink palette deliberately avoids the high-contrast urgency of typical news apps.", images: [{ src: `${IMG}tunedin-login.png`, caption: "Login screen", narrow: true }, { src: `${IMG}tunedin-home.png`, caption: "Home — capacity slider & mood selection", narrow: true }, { src: `${IMG}tunedin-feed.png`, caption: "Feed page — categorized news", narrow: true }] },
      { heading: "Content Components", text: "Designed expandable content cards that show article previews with source attribution, and a list view for scanning headlines quickly. Each section (Recommended Reading, Local News, Recent News) can be expanded or collapsed to give users control over information density.", images: [{ src: `${IMG}tunedin-card.png`, caption: "Card component — collapsed view", narrow: true }, { src: `${IMG}tunedin-list.png`, caption: "List view — expanded content sections", narrow: true }] },
    ],
